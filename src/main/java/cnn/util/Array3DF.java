...
public class Array3DF {
	...
	private float[] data;
	private float[][][] data3;
	public Array3DF(int dim1, int dim2, int dim3) {
		this.dim1 = dim1;
		this.dim2 = dim2;
		this.dim3 = dim3;
	...
	public int getLength1() {return dim1;}
	public int getLength2() {return dim2;}
	public int getLength3() {return dim3;}
